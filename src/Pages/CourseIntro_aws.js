...
export default class CourseIntro_aws extends Component {
    render() {
        return (
            <div>
                                                            ...
                                                            <div class="comment-content">
                                                                <form class="uk-grid-small" uk-grid>
                                                                    ...
                                                                    <div class="uk-width-1-2@s">
                                                                        ...
                                                                        <input class="uk-input" type="text" placeholder="Email">  </input>
                                                                    </div>
                                                ...
                                                <div class="uk-child-width-1-2 uk-grid-small mb-4" uk-grid>
                                                    <div>
                                                        <a href="course-resume.html"
                                                            ...
                                                            <i class="uil-play"></i> Start </a>
                                                    </div>
                                                    <div>
                                                        <a href="course-resume.html"
                                                            class="btn btn-danger uk-width-1-1 transition-3d-hover"> 
